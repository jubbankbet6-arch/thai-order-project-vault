...
export default function ChatHub() {
  ...
  const conversation = selected ? <>
    ...
    <div ref={chatTimelineRef} onScroll={handleTimelineScroll} className="relative flex min-h-[430px] flex-col justify-end gap-3 overflow-y-auto bg-[radial-gradient(circle_at_70%_20%,rgba(168,85,247,0.09),transparent_32%),#0b0910] p-5">
