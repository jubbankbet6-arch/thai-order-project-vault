...
function imageUrls(value: string | null | undefined) {
  ...
  try {
    ...
    const walk = (item: unknown) => {
      ...
      for (const child of Object.values(record)) if (Array.isArray(child)) child.forEach(walk);
    };
    if (Array.isArray(attachments)) attachments.forEach(walk);
    else walk(attachments);
    return urls;
  } catch {
    return [];
  }
